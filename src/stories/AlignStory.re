...
module Algins = {
  [@react.component]
  let make = () => {
    <Example title="Align" description="Align will center the children element on the X axis and Y axis">
    <Grid>
      <Box background={Colors.pink} border={`One(Colors.Pink.dirty)} padding=2 height="120" width="200">
